...
public class L23_MergeKSortedLists {
     ...
     * - 实现：
     *   - 与解法3不同，该解法使用标准归并排序思路，先对 lists 中的链表不断进行二分（partition），最后再两两归并（merge）；
     *   - 👉🏻 本解法中的二分实现可以与 L167_TwoSumII 解法1中的 binarySearch 方法对照记忆。
    ...
    public static void main(String[] args) {
        ...
        log(res);   // expects 1->1->2->3->4->4->5->6->NULL
